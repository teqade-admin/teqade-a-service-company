// Teqade's mark, styled like a periodic-table tile with the symbol "Tq", set in Figtree like the
// site's buttons.
export function TqLogo({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <span className="text-[17px] font-extrabold leading-none tracking-[-0.03em] text-foreground">
