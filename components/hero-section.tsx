      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid border border-border/70 bg-card/50 lg:grid-cols-[1.35fr_0.65fr]">
          <div className="relative overflow-hidden px-6 py-12 sm:px-10 sm:py-16 lg:px-14 lg:py-24">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row"><Button size="lg" onClick={openProjectForm} className="hero-button group h-13 rounded-none bg-primary px-6 font-bold text-primary-foreground"><span>Start a project</span><ArrowRight className="ml-7 h-4 w-4 transition-transform group-hover:translate-x-1" /></Button><Link href="#work"><Button size="lg" variant="outline" className="h-13 rounded-none border-border bg-transparent px-6 font-bold hover:bg-secondary"><Play className="mr-3 h-4 w-4" /> See our work</Button></Link></div>
          </div>
